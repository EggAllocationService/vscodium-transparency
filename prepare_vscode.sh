...
# disable auto updates, thats done through pacman
# Also I'm not also running an update server, so this wouldnt work anyways
# Also I'm pretty sure this doesnt work on linux
updateUrl='setpath(["updateUrl"]; "")'
